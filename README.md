...
## Migrate databases
`docker-compose run --rm djangoapp main/manage.py migrate` or `make migrate`.

## Collect static files
`docker-compose run --rm djangoapp main/manage.py collectstatic --no-input'` or `make collectstatic`.
...
## Documentation
https://www.delta-axis.me/documentation/